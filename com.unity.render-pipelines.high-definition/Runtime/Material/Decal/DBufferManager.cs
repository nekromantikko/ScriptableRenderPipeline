...
namespace UnityEngine.Experimental.Rendering.HDPipeline
{
    public class DBufferManager : MRTBufferManager
    {
        ...
        public override void CreateBuffers()
        {
            ...
            {
                m_RTs[dbufferIndex] = RTHandles.Alloc(Vector2.one, colorFormat: rtFormat[dbufferIndex], dimension: TextureDimension.Tex2DArray, sRGB: sRGBFlags[dbufferIndex], name: string.Format("DBuffer{0}", dbufferIndex));
            ...
            m_HTile = RTHandles.Alloc(size => new Vector2Int((size.x + 7) / 8, (size.y + 7) / 8), colorFormat: RenderTextureFormat.R8, dimension: TextureDimension.Tex2DArray, sRGB: false, enableRandomWrite: true, name: "DBufferHTile"); // Enable UAV
        }
