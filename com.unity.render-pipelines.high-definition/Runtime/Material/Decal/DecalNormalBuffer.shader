Shader "Hidden/HDRP/Material/Decal/DecalNormalBuffer"
{
    ...
    HLSLINCLUDE
        ...
        void FragNearest(Varyings input)
        {
            ...
            uint3 outCoord = uint3(input.texcoord * _ScreenSize.xy, unity_StereoEyeIndex);
            float4 GBufferNormal = _NormalBuffer[outCoord];
            ...
            _NormalBuffer[outCoord] = GBufferNormal;
        }
