...
namespace UnityEngine.Experimental.Rendering.HDPipeline
{
    ...
    public sealed class MotionBlur : VolumeComponent, IPostProcessComponent
    {
        ...
        [Tooltip("Maximum velocity, in pixels, for anything but camera rotation. This is limited due to limitation of the algorithm.")]
        public ClampedFloatParameter maxVelocity = new ClampedFloatParameter(64.0f, 0.0f, 64.0f);
        ...
        public ClampedFloatParameter cameraRotationVelocityClamp = new ClampedFloatParameter(0.15f, 0.0f, 0.2f);
