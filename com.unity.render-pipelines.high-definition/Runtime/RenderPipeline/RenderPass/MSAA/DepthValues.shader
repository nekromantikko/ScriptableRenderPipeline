Shader "Hidden/HDRP/DepthValues"
{
    HLSLINCLUDE
        ...
        Texture2DMSArray<float4> _NormalTextureMS;
        ...
        FragOut Frag1X(Varyings input)
        {
            ...
            float depthVal = LOAD_TEXTURE2D_EYE_MSAA(_DepthTextureMS, pixelCoords, 0).x;
            fragO.depthValues = float4(depthVal, depthVal, depthVal, 0.0f);
            fragO.normal = LOAD_TEXTURE2D_EYE_MSAA(_NormalTextureMS, pixelCoords, 0);
        ...
        FragOut Frag2X(Varyings input)
        {
            ...
            {
                float depthVal = LOAD_TEXTURE2D_EYE_MSAA(_DepthTextureMS, pixelCoords, sampleIdx).x;
