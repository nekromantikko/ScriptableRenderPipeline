...
namespace UnityEngine.Experimental.Rendering.HDPipeline
{
    ...
    public class IndirectLightingControllerEditor : VolumeComponentEditor
    {
        ...
        {
            PropertyField(m_IndirectDiffuseIntensity, CoreEditorUtils.GetContent("Indirect Diffuse Intensity|Sets the multiplier for baked diffuse lighting."));
            PropertyField(m_IndirectSpecularIntensity, CoreEditorUtils.GetContent("Indirect Specular Intensity|Sets the multiplier for reflected specular lighting."));
        }
    }
}
