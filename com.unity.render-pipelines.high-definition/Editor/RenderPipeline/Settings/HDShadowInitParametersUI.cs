...
namespace UnityEditor.Experimental.Rendering.HDPipeline
{
    ...
    static class HDShadowInitParametersUI
    {
        ...
        static readonly GUIContent k_ResolutionContent = CoreEditorUtils.GetContent("Resolution|Specifies the resolution of the shadow Atlas.");
        static readonly GUIContent k_Map16bContent = CoreEditorUtils.GetContent("16-bit|When enabled, this forces HDRP to use 16-bit shadow maps.");
        static readonly GUIContent k_DynamicRescaleContent = CoreEditorUtils.GetContent("Dynamic Rescale|When enabled, scales the shadow map size using the screen size of the Light to leave more space for other shadows in the atlas.");
        static readonly GUIContent k_MaxRequestContent = CoreEditorUtils.GetContent("Max Shadow on Screen|Sets the maximum number of shadows HDRP can handle on screen at once. See the documentation for details on how many shadows each light type casts.");
        static readonly GUIContent k_FilteringQualityContent = CoreEditorUtils.GetContent("Filtering Qualities");
        static readonly GUIContent k_QualityContent = CoreEditorUtils.GetContent("ShadowQuality|Specifies the quality of shadows. See the documentation for details on the algorithm HDRP uses for each preset.");
